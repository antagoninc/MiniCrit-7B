...
# ANTAGON-MINICRIT: Lazy imports with graceful fallback
# These imports require langchain-core to be installed
try:
    ...
    # ANTAGON-MINICRIT: langchain-core not installed
    import warnings

    warnings.warn(
        f"langchain_minicrit requires langchain-core to be installed. "
        f"Install with: pip install langchain-core. Error: {e}",
        ImportWarning,
    )
    __all__ = ["__version__"]
